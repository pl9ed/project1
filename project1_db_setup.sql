...
--
--UPDATE public.ERS_REIMBURSEMENT SET STATUS_ID=1 WHERE REIMB_ID=2;
--
--SELECT * FROM ers_reimbursement_full;
--SELECT REIMB_ID, AMOUNT, SUBMITTED, RESOLVED, DESCRIPTION, AUTHOR, RESOLVER, TYPE_ID, STATUS_ID FROM public.ERS_REIMBURSEMENT_FULL WHERE AUTHOR=1
--SELECT * FROM ERS_REIMBURSEMENT_FULL;